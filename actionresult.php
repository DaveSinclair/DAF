...
function actionresult($gp, $current_project, $current_phase, $actionresult_startviewdate, $actionresult_endviewdate, $actionresult_startviewtime, $actionresult_endviewtime, $actionresult_Ndays) {
   ...
   if ($gp['action'] === "create") {
      ...
      if (! isset($gp['ID'])) {
         ...
         show_all_actionresults1($status_db, $actionresult_startviewdate, $actionresult_endviewdate, $actionresult_startviewtime, $actionresult_endviewtime, $actionresult_Ndays);
...
function show_all_actionresults($status_db, $actionresult_startviewdate, $actionresult_endviewdate, $actionresult_startviewtime, $actionresult_endviewtime, $actionresult_Ndays) {
...
function show_all_actionresults1($status_db, $actionresult_startviewdate, $actionresult_endviewdate, $actionresult_startviewtime, $actionresult_endviewtime, $actionresult_Ndays) {
...
echo <<<_END
   ...
   <script type="text/javascript">
      ...
      function formatScenarioresultID(val, rowId) {      
        var ID=this.grid.store.getValue(this.grid.getItem(rowId), 'ScenarioresultID');
...
echo <<<_END
         ...
         var grid = new dojox.grid.DataGrid({    // use the adapter to give the grid a Dojo Data compliant interface to the store    
                            ...
                            structure: [ {name:"ID", field:"ID", width:"3em", styles:"text-align:center;border-width: 1px; border-color:red;"},        
		                                 {name:"Scenario Result ID", field:"ScenarioresultID", width:"8em", styles:"text-align:center;", formatter: formatScenarioresultID},        
		                    ...
		                    "ActionresultStatus");
_END;
         echo "grid.setQuery({Start: \"[" .  $actionresult_startviewdate . " " . $actionresult_startviewtime . "," . 
                                             $actionresult_endviewdate . " " . $actionresult_endviewtime . "]\"});";
echo <<<_END
		 grid.startup();
