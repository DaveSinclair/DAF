...
int main(int argc, char **argv) {
   ...
   Iu16  type = 10;       int  type_flag = 0;        int type_offset = 0;
   Iu32  serial = 567;    int  serial_flag = 0;      int serial_offset = 2; 
   Iu32  origin;          int  origin_flag = 0;      int origin_offset = 6;                                  
   Iu32  duration = 0;    int  duration_flag = 0;    int duration_offset = 10;                           
   Iu16  steps = 100;     int  steps_flag = 0;       int steps_offset = 14;
   Iu16  spare = 0;       int  spare_flag = 0;       int spare_offset = 16;
   Iu16  checksum;        int  checksum_flag = 0;    int checksum_offset = 18;
