...
void print_scenario_console_log(char *msg)
{
    ...
    printf(msg);       // TODO DAS remove DEBUG
...
#define SUBNAME "get_testcase_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            testcase->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            safecpy(testcase->Name, (*row)[i], sizeof(testcase->Name));
            break;
...
#define SUBNAME "get_actiontype_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            actiontype->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            safecpy(actiontype->Type, (*row)[i], sizeof(actiontype->Type));
            break;

        case 2:
            safecpy(actiontype->Description, (*row)[i], sizeof(actiontype->Description));
            break;
...
#define SUBNAME "get_action_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            action->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            action->ScenarioID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 2:
            action->ActiontypeID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 3:
            safecpy(action->Description, (*row)[i], sizeof(action->Description));
            break;

        case 4:
            action->Stepnumber = strtoull((*row)[i], NULL, 0);
            break;

        case 5:
            safecpy(action->Hostselectortype, (*row)[i], sizeof(action->Hostselectortype));
            break;

        case 6:
            safecpy(action->Hostselectorvalue, (*row)[i], sizeof(action->Hostselectorvalue));
            break;

        case 7:
            action->CollectorsetID = strtoull((*row)[i], NULL, 0);
            break;

        case 8:
            action->TestcaseID = strtoull((*row)[i], NULL, 0);
            break;

        case 9:
            safecpy(action->Parameters, (*row)[i], sizeof(action->Parameters));
            break;

        case 10:
            action->EnvironmentID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 11:
            safecpy(action->Duration, (*row)[i], sizeof(action->Duration));
            break;

        case 12:
            action->Maxduration = (Iu32) strtoull((*row)[i], NULL, 0);
            break;
...
#define SUBNAME "get_actionresult_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            actionresult->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            actionresult->ScenarioresultID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 2:
            safecpy(actionresult->Actiontype, (*row)[i], sizeof(actionresult->Actiontype));
            break;

        case 3:
            actionresult->Stepnumber = strtoull((*row)[i], NULL, 0);
            break;

        case 4:
            safecpy(actionresult->Status, (*row)[i], sizeof(actionresult->Status));
            break;

        case 5:
            safecpy(actionresult->Hostname, (*row)[i], sizeof(actionresult->Hostname));
            break;

        case 6:
            safecpy(actionresult->Testcase, (*row)[i], sizeof(actionresult->Testcase));
            break;

        case 7:
            safecpy(actionresult->Invocation, (*row)[i], sizeof(actionresult->Invocation));
            break;

        case 8:
            actionresult->Pass = strtoull((*row)[i], NULL, 0);
            break;

        case 9:
            safecpy(actionresult->Start, (*row)[i], sizeof(actionresult->Start));
            break;

        case 10:
            safecpy(actionresult->End, (*row)[i], sizeof(actionresult->End));
            break;

        case 11:
            safecpy(actionresult->Comments, (*row)[i], sizeof(actionresult->Comments));
            break;
                          ...
                          workqueue_t  *workqueue)
{
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            workqueue->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;
...
#define SUBNAME "get_workqueuerequest_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            workrequest->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            safecpy(workrequest->Project, (*row)[i], sizeof(workrequest->Project));
            break;

        case 2:
            safecpy(workrequest->Phase, (*row)[i], sizeof(workrequest->Phase));
            break;

        case 3:
            safecpy(workrequest->RequestType, (*row)[i], sizeof(workrequest->RequestType));
            break;

        case 4:
            workrequest->TesterID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 5:
            safecpy(workrequest->State, (*row)[i], sizeof(workrequest->State));
            break;

        case 6:
            safecpy(workrequest->Tablename1, (*row)[i], sizeof(workrequest->Tablename1));
            break;

        case 7:
            workrequest->ObjectID1 = strtoull((*row)[i], NULL, 0);
            break;

        case 8:
            safecpy(workrequest->Tablename2, (*row)[i], sizeof(workrequest->Tablename2));
            break;

        case 9:
            workrequest->ObjectID2 = strtoull((*row)[i], NULL, 0);
            break;

        case 10:
            safecpy(workrequest->Tablename3, (*row)[i], sizeof(workrequest->Tablename3));
            break;

        case 11:
            workrequest->ObjectID3 = strtoull((*row)[i], NULL, 0);
            break;

        case 12:
            safecpy(workrequest->Tablename4, (*row)[i], sizeof(workrequest->Tablename4));
            break;

        case 13:
            workrequest->ObjectID4 = strtoull((*row)[i], NULL, 0);
            break;

        case 14:
            safecpy(workrequest->Tablename5, (*row)[i], sizeof(workrequest->Tablename5));
            break;

        case 15:
            workrequest->ObjectID5 = strtoull((*row)[i], NULL, 0);
            break;
...
#define SUBNAME "get_scenario_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            scenario->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            safecpy(scenario->Name, (*row)[i], sizeof(scenario->Name));
            break;

        case 2:
            safecpy(scenario->Author, (*row)[i], sizeof(scenario->Author));
            break;

        case 3:
            scenario->OutcomeactionID = strtoull((*row)[i], NULL, 0);
            break;

        case 4:
            safecpy(scenario->Createdon, (*row)[i], sizeof(scenario->Createdon));
            break;

        case 5:
            safecpy(scenario->Lastchanged, (*row)[i], sizeof(scenario->Lastchanged));
            break;
...
#define SUBNAME "get_scenarioresult_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            scenarioresult->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            safecpy(scenarioresult->Project, (*row)[i], sizeof(scenarioresult->Project));
            break;

        case 2:
            safecpy(scenarioresult->Phase, (*row)[i], sizeof(scenarioresult->Phase));
            break;

        case 3:
            safecpy(scenarioresult->Scenarioname, (*row)[i], sizeof(scenarioresult->Scenarioname));
            break;

        case 4:
            safecpy(scenarioresult->Jobname, (*row)[i], sizeof(scenarioresult->Jobname));
            break;

        case 5:
            safecpy(scenarioresult->State, (*row)[i], sizeof(scenarioresult->State));
            break;

        case 6:
            scenarioresult->Actionsinscenario = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 7:
            scenarioresult->Actionsattempted = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 8:
            scenarioresult->Actionscompleted = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 9:
            scenarioresult->Actionspassed = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 10:
            scenarioresult->Actionsfailed = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 11:
            scenarioresult->Pass = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 12:
            safecpy(scenarioresult->Start, (*row)[i], sizeof(scenarioresult->Start));
            break;

        case 13:
            safecpy(scenarioresult->End, (*row)[i], sizeof(scenarioresult->End));
            break;

        case 14:
            safecpy(scenarioresult->Teststand, (*row)[i], sizeof(scenarioresult->Teststand));
            break;

        case 15:
            scenarioresult->TeststandrecordID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 16:
            safecpy(scenarioresult->Testlevel, (*row)[i], sizeof(scenarioresult->Testlevel));
            break;

        case 17:
            scenarioresult->TestlevelrecordID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 18:
            safecpy(scenarioresult->Tester, (*row)[i], sizeof(scenarioresult->Tester));
            break;

        case 19:
            safecpy(scenarioresult->Loglocation, (*row)[i], sizeof(scenarioresult->Loglocation));
            break;

        case 20:
            safecpy(scenarioresult->Scenariologfilename, (*row)[i], sizeof(scenarioresult->Scenariologfilename));
            break;

        case 21:
            safecpy(scenarioresult->Comments, (*row)[i], sizeof(scenarioresult->Comments));
            break;
...
#define SUBNAME "get_host_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            host->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            host->TeststandID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 2:
            safecpy(host->Name, (*row)[i], sizeof(host->Name));
            break;

        case 3:
            safecpy(host->Type, (*row)[i], sizeof(host->Type));
            break;

        case 4:
            safecpy(host->Model, (*row)[i], sizeof(host->Model));
            break;

        case 5:
            safecpy(host->Serial, (*row)[i], sizeof(host->Serial));
            break;

        case 6:
            safecpy(host->Hostselectorvalue, (*row)[i], sizeof(host->Hostselectorvalue));
            break;

        case 7:
            host->Teststandprimary = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 8:
            safecpy(host->Comments, (*row)[i], sizeof(host->Comments));
            break;

        case 9:
            safecpy(host->Agentstatus, (*row)[i], sizeof(host->Agentstatus));
            break;

        case 10:
            safecpy(host->Agentstatusdate, (*row)[i], sizeof(host->Agentstatusdate));
            break;
...
#define SUBNAME "get_collectorvalue_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            collectorvalue->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            collectorvalue->CollectortypeID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 2:
            collectorvalue->HostID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 3:
            safecpy(collectorvalue->Value, (*row)[i], sizeof(collectorvalue->Value));
            break;
...
#define SUBNAME "get_collectortype_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            collectortype->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            safecpy(collectortype->Name, (*row)[i], sizeof(collectortype->Name));
            break;

        case 2:
            collectortype->Builtin = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 3:
            safecpy(collectortype->OStype, (*row)[i], sizeof(collectortype->OStype));
            break;

        case 4:
            safecpy(collectortype->Invocation, (*row)[i], sizeof(collectortype->Invocation));
            break;
...
#define SUBNAME "get_collectorset_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            collectorset->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            safecpy(collectorset->Name, (*row)[i], sizeof(collectorset->Name));
            break;

        case 2:
            safecpy(collectorset->Description, (*row)[i], sizeof(collectorset->Description));
            break;
...
#define SUBNAME "get_collectorsetmember_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            collectorsetmember->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            collectorsetmember->CollectortypeID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 2:
            safecpy(collectorsetmember->Requiredvalue, (*row)[i], sizeof(collectorsetmember->Requiredvalue));
            break;

        case 3:
            collectorsetmember->CollectorsetID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;
...
#define SUBNAME "get_environment_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            environment->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            safecpy(environment->Name, (*row)[i], sizeof(environment->Name));
            break;

        case 2:
            safecpy(environment->Description, (*row)[i], sizeof(environment->Description));
            break;
...
#define SUBNAME "get_environmentvalue_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            environmentvalue->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            safecpy(environmentvalue->Name, (*row)[i], sizeof(environmentvalue->Name));
            break;

        case 2:
            safecpy(environmentvalue->Value, (*row)[i], sizeof(environmentvalue->Value));
            break;

        case 3:
            environmentvalue->EnvironmentID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;
...
#define SUBNAME "get_outcomeaction_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            outcomeaction->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            safecpy(outcomeaction->Name, (*row)[i], sizeof(outcomeaction->Name));
            break;

        case 2:
            safecpy(outcomeaction->Actiononpass, (*row)[i], sizeof(outcomeaction->Actiononpass));
            break;

        case 3:
            safecpy(outcomeaction->Actiononfail, (*row)[i], sizeof(outcomeaction->Actiononfail));
            break;

        case 4:
            outcomeaction->Scenariotoberunonpass = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 5:
            outcomeaction->Scenariotoberunonfail = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 6:
            safecpy(outcomeaction->Erroraction, (*row)[i], sizeof(outcomeaction->Erroraction));
            break;

        case 7:
            safecpy(outcomeaction->Notificationonpass, (*row)[i], sizeof(outcomeaction->Notificationonpass));
            break;

        case 8:
            safecpy(outcomeaction->Notificationonfail, (*row)[i], sizeof(outcomeaction->Notificationonfail));
            break;

        case 9:
            outcomeaction->TesterID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 10:
            outcomeaction->MaillistID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;
...
#define SUBNAME "get_user_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            user->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            safecpy(user->Firstname, (*row)[i], sizeof(user->Firstname));
            break;

        case 2:
            safecpy(user->Lastname, (*row)[i], sizeof(user->Lastname));
            break;

        case 3:
            safecpy(user->Area, (*row)[i], sizeof(user->Area));
            break;

        case 4:
            safecpy(user->Email, (*row)[i], sizeof(user->Email));
            break;

        case 5:
            user->Admin = (bool_t) strtoull((*row)[i], NULL, 0);
            break;

        case 6:
            safecpy(user->Password, (*row)[i], sizeof(user->Password));
            break;
...
#define SUBNAME "get_objecttype_record"
    ...
    for (i = 0; i < mysql_num_fields(res_set); i++)
    {
        ...
        {
        case 0:
            objecttype->ID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 1:
            objecttype->ParentID = (Iu32) strtoull((*row)[i], NULL, 0);
            break;

        case 2:
            safecpy(objecttype->Name, (*row)[i], sizeof(objecttype->Name));
            break;

        case 3:
            safecpy(objecttype->Description, (*row)[i], sizeof(objecttype->Description));
            break;
        ...
        if ((res_set = check_for_res_set(SUBNAME, sql_connection, query)))
        {
            ...
            while (((row = mysql_fetch_row(res_set)) != NULL) && (*num_records < max_num_records))
            {
                ...
                for (i = 0; i < mysql_num_fields(res_set); i++)
                {
                    ...
                    {
                    case 0:
                        safecpy(required_values->Collectorsetname, row[i] , sizeof(required_values->Collectorsetname));
                        break;
                    ...
                    case 2:
                        safecpy(required_values->Collectortypename, row[i] , sizeof(required_values->Collectortypename));
                        break;

                    case 3:
                        safecpy(required_values->Requiredvalue, row[i], sizeof(required_values->Requiredvalue));
                        break;

                    case 4:
                        safecpy(required_values->Comparator, row[i], sizeof(required_values->Comparator));
                        break;
        ...
        if ((res_set = check_for_res_set(SUBNAME, sql_connection, query)))
        {
            ...
            while ((row = mysql_fetch_row(res_set)) != NULL)
            {
                ...
                for (i = 0; i < mysql_num_fields(res_set); i++)
                {
                    ...
                    {
                    case 0:
                        safecpy(q->Collectorsetname, row[i] , sizeof(q->Collectorsetname));
                        break;
                    ...
                    case 2:
                        safecpy(q->Collectortypename, row[i] , sizeof(q->Collectortypename));
                        break;

                    case 3:
                        safecpy(q->Requiredvalue, row[i], sizeof(q->Requiredvalue));
                        break;
...
#define SUBNAME "select_host_for_action"
    ...
    else
    {
        ...
        else
        {
            ...
            if (MATCH(action->Hostselectortype, "BySelectorValue"))
            {
                sk = 1;
            }
    ...
    if (hosts_in_use   != NULL)
    {
        free(hosts_in_use);
    }

    if (suitable_hosts != NULL)
    {
        free(suitable_hosts);
    }
...
#define SUBNAME "select_host_for_codelevel"
    ...
    if (host_collectorvalues != NULL)
    {
        free(host_collectorvalues);
    }
        ...
        if ((res_set = check_for_res_set(SUBNAME, sql_connection, query)))
        {
            ...
            while (((row = mysql_fetch_row(res_set)) != NULL) && (*num_records < num_rows))
            {
                ...
                for (i = 0; i < mysql_num_fields(res_set); i++)
                {
                    ...
                    {
                    case 0:
                        safecpy(p->levelname, row[i] , sizeof(p->levelname));
                        break;

                    case 1:
                        safecpy(p->collectortypename, row[i] , sizeof(p->collectortypename));
                        break;
                    ...
                    case 3:
                        safecpy(p->desired_level_value, row[i] , sizeof(p->desired_level_value));
                        break;

                    case 4:
                        safecpy(p->objecttype, row[i] , sizeof(p->objecttype));
                        break;

                    case 5:
                        safecpy(p->invocation, row[i] , sizeof(p->invocation));
                        break;

                    case 6:
                        safecpy(p->OStype, row[i] , sizeof(p->OStype));
                        break;
...
/*--------------------------------------------------------------------------------------------------------*/
/*                                                                                                        */
/* PROCEDURE:    archive_step_from_workqueue                                                              */
/*                                                                                                        */
/* PARAMS IN:    status_database_name                                                                     */
/*                                                                                                        */
/*               ScenarioresultID                                                                         */
...
void archive_step_from_workqueue(MYSQL *sql_connection, char *status_database_name, int ScenarioresultID, int Stepnumber)
{

#undef  SUBNAME
#define SUBNAME "archive_step_from_workqueue"
...
#define SUBNAME "process_workqueue"
    ...
    if (num_workqueue_records > 0)
    {
        ...
        for (i=0; i<num_workqueue_records; i++)
        {
            ...
            // first, find out if this workqueue record is associated with a scenario that we have
            // already found to be active, if not, then add the scenario to the list of known active scenarios
     ...
     printf("Copy Phase %s to %s\n", p_workqueues[i].Phase, steps[num_known_step].Phase);
        ...
        snprintf(msg, sizeof(msg), "num_known_scenario %d num_known_step %d num_workqueue_records %d\n", num_known_scenario, num_known_step, num_workqueue_records);
        print_scenario_console_log(msg);
        ...
        for (i=0; i<num_known_step; i++)
        {
            ...
            snprintf(msg, sizeof(msg), "Active Step....ScenarioID %u ScenarioresultID %u Stepnumber %u\n",
        ...
        for (i=0; i<num_known_step; i++)
        {
          ...
          printf("DEBUG DEBUG:  i %d Step %d Project %s  Phase %s\n", i, Stepnumber, steps[i].Project, steps[i].Phase);
                    ...
                    archive_step_from_workqueue(sql_connection, status_database_name, ScenarioresultID, Stepnumber);
        ...
        if ((res_set = check_for_res_set(SUBNAME, sql_connection, query)))
        {
            ...
            while ((row = mysql_fetch_row(res_set)) != NULL)
            {
                ...
                else if (MATCH(workqueue.State, "Notstarted"))
                {
                    ...
                    /* --------------------------------------------------------------------------------------------- */
                    /* Create a new actionresult row for this particular workrequest                                  */
                    /* --------------------------------------------------------------------------------------------- */
...
#define SUBNAME "af_work_daemon"
    ...
    while (1)
    {
        ...
        else
        {
            ...
            snprintf(msg, sizeof(msg), "af_daemon: could not connect to mysql database: %s %s %s %s %d %s: %s\n",
                     p_af_daemon_thread_data->sql_servername,
                     p_af_daemon_thread_data->sql_username,
                     p_af_daemon_thread_data->sql_password,
                     p_af_daemon_thread_data->sql_databasename,
            ...
            for (i=0; i < num_host_records; i++)
            {
                ...
                if (!p_af_collector_thread_data->simulator_mode)
                {
                    ...
                    if (remote_client == (CLIENT *) NULL)
                    {
                        ...
                        snprintf(errmsg1, sizeof(errmsg1), "%s clnt_create failed for remote host %s: ", SUBNAME, hosts[i].Name);
                        snprintf(msg,    sizeof(msg),    "%s\n", clnt_spcreateerror(errmsg1));
                    ...
                    else
                    {
                        ...
                        if ((stat = clnt_call(remote_client, CLIENT_REMOTE_CLIENT_QUERY_VERSION,
                                              ...
                                              TIMEOUT)) != RPC_SUCCESS)
                        {
                            clnt_stat_decode(stat, errmsg1, sizeof(errmsg1));
                            snprintf(msg, sizeof(msg) ,"%s: clnt_call() for proc %lu failed - status = %d (%s)\n",
                                     SUBNAME, (long) CLIENT_REMOTE_CLIENT_QUERY_VERSION, stat, errmsg1);
                            print_msg_to_console_log(msg);
                                                               ...
                                                               builtin_collector_name, &collectortypeID))
                                    {
                                                                          ...
                                                                          num_collectorvalue_records, &collectorvalueID, &index))
                                        {
                                            ...
                                            if (!MATCH(S_Value, collectorvalues[index].Value))
                                            {
                                                ...
                                                rc = perform_update(SUBNAME "xxx4", sql_connection, "daf.collectorvalue", fields1, values1, where, errmsg1, sizeof(errmsg1));
                        ...
                        for (j=0; j < num_user_collectortypes; j++)
                        {
                                                  ...
                                                  TIMEOUT)) != RPC_SUCCESS)
                            {
                                clnt_stat_decode(stat, errmsg1, sizeof(errmsg1));
                                snprintf(msg, sizeof(msg) ,"%s: clnt_call() for proc %lu failed - status = %d (%s)\n",
                                         SUBNAME, (long) CLIENT_REMOTE_CLIENT_RUN_CMD, stat, errmsg1);
                                print_msg_to_console_log(msg);
                            ...
                            else
                            {
                                                           ...
                                                           user_collector_name, &collectortypeID))
                                {
                                                                      ...
                                                                      num_collectorvalue_records, &collectorvalueID, &index))
                                    {
                                        ...
                                        {
                                            snprintf(where, sizeof(where), "ID = %u", collectorvalueID);
                                            rc = perform_update(SUBNAME, sql_connection, "daf.collectorvalue", fields1, values1, where, errmsg1, sizeof(errmsg1));
...
#define HOSTS_PER_SCAN_ELEMENT 5
    ...
    int                     i;
    int                     rc;
    char                    errmsg[MAX_MSG_LEN], errmsg1[MAX_MSG_LEN];
    ...
    while (1)
    {
        ...
        if (sql_connection != NULL)
        {
            ...
            for (i=0; i < num_host_records; i++)
            {
                ...
                rc = perform_update(SUBNAME, sql_connection, "daf.host", fields, values, where, errmsg1, sizeof(errmsg1));
