...
void print_usage() {
	...
	printf("        -detailedhelp\n");
	printf("   or\n");
	printf("   daf  -remote hostname [-msglevel N] [-timeout N] [-consolelog pathname]\n");
	...
	printf("         -execute cmdstring [-run_in_background] [-ident identstring] \n");
        printf("             [-workqueueID N] [-sqlserver hostname] [-sqluser username] [-sqlpassword password] [-sqldatabase databasename] [-sqlport N]\n");
	printf("         -report cmds\n");
	...
	printf("   daf  {-service|-multiprocess_service|-threaded_service} [install|start|stop|delete|run] [-msglevel N] [-consolelog pathname] [-simulator_mode]\n");
	printf("             [-sqlserver hostname] [-sqluser username] [-sqlpassword password] [-sqldatabase databasename] [-sqlport N]\n");
	printf("   Use\n\n");
	printf("   daf -detailedhelp\n\n");
	printf("   for a full description\n\n");
...
#else
	printf("   daf  -remote hostname [-msglevel N] [-timeout N]\n");
	printf("         -query version\n");
	printf("         -execute cmdstring [-run_in_background] [-ident identstring]\n");
	printf("         -report cmds\n");
	printf("         -query  tag -tag N\n");
	printf("         -clear  tag -tag N\n");
	printf("         -cancel tag -tag N\n");
	printf("         -query  alltags\n");
	printf("         -clear  alltags\n");
	printf("         -clear  shared_memory\n");
	printf("         -get    newident\n");
	printf("         -clear  ident\n");
	printf("         -query  ident -ident identstring\n");
	printf("         -cancel ident -ident string\n");
	printf("         -dirlist remotepathname\n");
	printf("         -getfile localpathname remotepathname\n");
	printf("         -putfile localpathname remotepathname\n");
	printf("         -debug sql\n");
#endif
	printf("   Use\n\n");
	printf("   daf -detailedhelp\n\n");
...
void start_af_daemon(parameters_t *parameters) {
	...
	if ((rc = pthread_create( &pthread, &attr, af_daemon, (void*) &af_daemon_thread_data)) != 0) {
...
void start_af_collector(parameters_t *parameters) {
	...
	if ((rc = pthread_create(&pthread, &attr, af_collector, (void*) &af_collector_thread_data)) != 0) {
...
int msglevel = 0; /* <<<<<<<<<<<<<<<< */
	...
	data_ptr-> transp = transport_handle;
	    ...
	    rc = pthread_create(&p_thread, &attr, daf_prog_dispatcher_1, (void *) data_ptr);
...
#ifndef DAF_AGENT
        start_af_daemon(parameters);
        start_af_collector(parameters);
...
int main(int argc, char **argv) {
	...
	if (parameters.execute_flag) {
           ...
           exit_rc = remote_client_cmd(parameters.remotehostname, run_in_shell, parameters.cmdstring, parameters.identstring,  parameters.run_in_background_flag, 
                                       ...
                                       parameters.sql_databasename, parameters.sql_port);
