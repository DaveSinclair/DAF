...
_END;
   ...
   echo '<tr><th>Name</th>';
   echo '<td><input type="text" name="value" size = "' . DAF_ENVIRONMENT_VALUE_LEN . '" maxlength="' . DAF_ENVIRONMENT_VALUE_LEN . '" ' . 
        'dojoType="dijit.form.ValidationTextBox" style="width: ' . DAF_ENVIRONMENT_VALUE_LEN . 'em;" regExp=".{1,' . DAF_ENVIRONMENT_VALUE_LEN . '}" required="true" trim="true" promptMessage="Enter a Host Selector Value" ' . 
        'invalidMessage="Invalid Description (must be 1 to ' . DAF_ENVIRONMENT_VALUE_LEN . ' characters)"/>';
   echo "</td></tr>\n";
   echo "</table>\n";
