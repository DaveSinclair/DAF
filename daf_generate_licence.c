...
int main(int argc, char **argv) {
   ...
   Iu16  type = 10;                                  int type_offset = 0;
   Iu32  serial = 567;                               int serial_offset = 2; 
   Iu32  origin;          int  origin_flag = 0;      int origin_offset = 6;                                  
   Iu32  duration = 0;                               int duration_offset = 10;                           
   Iu16  actions = 100;                              int actions_offset = 14;
   Iu16  spare = 0;                                  int spare_offset = 16;
