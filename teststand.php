  ...
  if ($gp['object'] !== "teststand") {
   ...
   if (isset($gp['operation'])) {
      ...
      if ($gp['operation'] === "create") {      
         ...
         if ((count_rows("daf.teststand", "Name = '" . $gp['name'] . "'") > 0) && ($gp['name'] != $gp['originalname'])) {
...
_END;
   ...
   cellbutton(null, "teststand_cancel", "Cancel", "index.php?object=teststande&action=show", null);
